...
const filterStringsWithVowels = (arr) => {
  ...
  let strings = arr.filter(string => string.match(regex));
  return strings;
};
...
const getStatName = (arr, minBaseStat) => {
  let statsData = getBaseStatGreaterThan(arr, minBaseStat);
...
const evenOddNumericValues = (arr) => {
  let numbers = arr.filter(value => Number.isInteger(value));
